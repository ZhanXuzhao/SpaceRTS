...
var _tl: Label   # top-left     (Label1)
var _tr: Label   # top-right    (Label2)
var _bl: Label   # bottom-left  (Label3)
var _br: Label   # bottom-right (Label4)
